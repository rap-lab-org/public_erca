...
// protected:
  ...
  bool do_truncation = true; // by default, this data structure is for EMOA* and vectors can be truncated.
    // This is only added for this Kd frontier for now @2022-12-14.
};
